    ...
    <body>
        <h1>NASA GeneLab Data API reference</h1>
            ...
            <h3>{url_root}/<a style='background:#eedd55' name='dataset_accession'>dataset_accession</a></h3>
                ...
                <b>Type</b>: string<br>
                <b>Regex</b>: <code>GLDS-[0-9]+</code><br>
                <b>Description</b>: Returns information about the dataset and
                the assays it contains. Columns: resource type, name, factors
                associated with it, file types available, protocols used.<br>
                <b>Example</b>:
                <a href='{url_root}/GLDS-111/?fmt=html'>{url_root}/<span style='background:#eedd55'>GLDS-111</span>/?<span style='background:#cccccc'>fmt=html</span></a><br>
    </body>
</html>
"""
